...
$consoleApp->add(new GeocodePlaceCommand($app['event_command_bus'], $app['search_results_generator'], $app['place_jsonld_repository']));
$consoleApp->add(new GeocodeEventCommand($app['event_command_bus'], $app['search_results_generator'], $app['event_jsonld_repository']));
