...
use CultuurNet\UDB3\Console\ChangeOfferOwner;
use CultuurNet\UDB3\Console\ChangeOfferOwnerInBulk;
use CultuurNet\UDB3\Console\ChangeOrganizerOwner;
use CultuurNet\UDB3\Console\ChangeOrganizerOwnerInBulk;
use CultuurNet\UDB3\Console\ConsumeCommand;
use CultuurNet\UDB3\Console\EventAncestorsCommand;
use CultuurNet\UDB3\Console\FireProjectedToJSONLDCommand;
use CultuurNet\UDB3\Console\FireProjectedToJSONLDForRelationsCommand;
use CultuurNet\UDB3\Console\GeocodeEventCommand;
use CultuurNet\UDB3\Console\GeocodeOrganizerCommand;
use CultuurNet\UDB3\Console\GeocodePlaceCommand;
use CultuurNet\UDB3\Console\ImportOfferAutoClassificationLabels;
use CultuurNet\UDB3\Console\ProcessDuplicatePlaces;
use CultuurNet\UDB3\Console\PurgeModelCommand;
use CultuurNet\UDB3\Console\ReindexEventsWithRecommendations;
use CultuurNet\UDB3\Console\ReindexOffersWithPopularityScore;
use CultuurNet\UDB3\Console\RemoveFacilitiesFromPlace;
use CultuurNet\UDB3\Console\RemoveLabelOffer;
use CultuurNet\UDB3\Console\RemoveLabelOrganizer;
use CultuurNet\UDB3\Console\ReplaceNewsArticlePublisher;
use CultuurNet\UDB3\Console\ReplayCommand;
use CultuurNet\UDB3\Console\UpdateBookingAvailabilityCommand;
use CultuurNet\UDB3\Console\UpdateEventsAttendanceMode;
use CultuurNet\UDB3\Console\UpdateOfferStatusCommand;
use CultuurNet\UDB3\Console\UpdateUniqueLabels;
use CultuurNet\UDB3\Console\UpdateUniqueOrganizers;
