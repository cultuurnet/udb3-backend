...
use CultuurNet\UDB3\Container\CachedContainer;
...
$fileCache = new FileCache(__DIR__ . '/.container.cache', 1000 * 60 * 5);

$container = new CachedContainer(function (Container $container) {
