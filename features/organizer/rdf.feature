Feature: Test RDF projection of organizers
  ...
  Scenario: Create an organizer with only the required fields
    ...
    Then the RDF response should match organisation projection "organizers/rdf/organizer.ttl"
  ...
  Scenario: Create an organizer with address
    ...
    And I accept "text/turtle"
    When I get the RDF of organizer with id "%{organizerId}"
    Then the RDF response should match organisation projection "organizers/rdf/organizer-with-address.ttl"
  ...
  Scenario: Create an organizer with contact point
    ...
    And I accept "text/turtle"
    When I get the RDF of organizer with id "%{organizerId}"
    Then the RDF response should match organisation projection "organizers/rdf/organizer-with-contact-point.ttl"
  ...
  Scenario: Create an organizer with labels
    ...
    And I accept "text/turtle"
    When I get the RDF of organizer with id "%{organizerId}"
    Then the RDF response should match organisation projection "organizers/rdf/organizer-with-labels.ttl"
  ...
  Scenario: Create an organizer with images
    ...
    And I accept "text/turtle"
    When I get the RDF of organizer with id "%{organizerId}"
    Then the RDF response should match organisation projection "organizers/rdf/organizer-with-images.ttl"
  ...
  Scenario: Create an organizer with description
    ...
    And I accept "text/turtle"
    When I get the RDF of organizer with id "%{organizerId}"
    Then the RDF response should match organisation projection "organizers/rdf/organizer-with-description.ttl"
