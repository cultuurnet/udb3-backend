Feature: Test getting creator ownership
    Background:
        Given I am using the UDB3 base URL
        And I am using an UiTID v1 API key of consumer "uitdatabank"
        And I send and accept "application/json"

    Scenario: Getting the creator of an ownership as creator
        ...
        When I send a GET request to "/ownerships/%{ownershipId}/creator"
    ...
    Scenario: Getting the creator of an ownership as a different user
        Given I am authorized as JWT provider v2 user "dev_e2e_test"
        And I create a minimal organizer and save the "id" as "organizerId"
    ...
    Scenario: Getting the creator of an ownership that you're not an owner of is not allowed
        ...
        And I wait for the organizer with url "/organizers/%{organizerId}" to be indexed
        # random user id
        And I request ownership for "d920febc-8ff6-47af-a1f1-9897e166838f" on the organizer with organizerId "%{organizerId}" and save the "id" as "ownershipId"
