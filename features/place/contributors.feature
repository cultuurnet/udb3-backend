Feature: Test the UDB3 places contributors endpoint
  ...
  Scenario: Places have no contributors by default
    When I send a GET request to "%{placeUrl}/contributors"
  ...
  Scenario: Update contributors
    ...
    """
    When I send a PUT request to "%{placeUrl}/contributors"
  ...
  Scenario: Users should not be allowed to view contributors of other places
    Given I set the JSON request payload to:
    """
    [
      "user@example.com",
  ...
  Scenario: Users should be able to edit places when they are a contributor
    Given I set the JSON request payload to:
    """
    [
      "dev+invoerder_dfm@publiq.be",
