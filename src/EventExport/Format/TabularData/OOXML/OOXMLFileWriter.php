...
class OOXMLFileWriter implements TabularDataFileWriterInterface
{
    ...
    public function __construct(string $filePath)
    {
        ...
        // The faq column holds a line per question, and the description column keeps the line
        // breaks of its markup. Excel only shows those as line breaks when the cell wraps its text.
        // Rows keep their automatic height, so they grow to fit whatever a cell wraps to.
