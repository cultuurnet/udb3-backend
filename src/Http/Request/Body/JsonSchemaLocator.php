...
final class JsonSchemaLocator
{
    ...
    public const EVENT_DEPARTURE_PLACES_PUT = 'event-departurePlaces-put.json';
    public const EVENT_CHILDREN_ONLY_PUT = 'event-childrenOnly-put.json';
    ...
    public const EVENT_BIRTHDATE_RANGE_PUT = 'event-birthdateRange-put.json';
