...
class DBALRecommendationRepositoryTest extends TestCase
{
    ...
    private DBALRecommendationRepository $dbalRecommendationRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->dbalRecommendationRepository = new DBALRecommendationRepository($this->getConnection());
    }
    ...
    public function it_can_get_recommendations_by_event_id(): void
    {
        $this->assertEquals(
            ...
            $this->dbalRecommendationRepository->getByEvent('342493ef-f0eb-412b-88e4-6693d9b12870')
        );
    }
    ...
    public function it_handles_empty_recommendations_by_event_id(): void
    {
        $this->assertEquals(
            new Recommendations(),
            $this->dbalRecommendationRepository->getByEvent('8701291e-8c0a-4aa1-badb-4e06c4f06ec7')
        );
    }
    ...
    public function it_can_get_recommendations_by_recommended_event_id(): void
    {
        $this->assertEquals(
            ...
            $this->dbalRecommendationRepository->getByRecommendedEvent('ab56d8f9-e92a-4eac-a430-c57a78d2988e')
        );
    }
    ...
    public function it_handles_empty_recommendations_by_recommended_event_id(): void
    {
        $this->assertEquals(
            new Recommendations(),
            $this->dbalRecommendationRepository->getByRecommendedEvent('0ffe651c-9d84-4ffd-aa95-8b8158647f9f')
        );
    }
}
