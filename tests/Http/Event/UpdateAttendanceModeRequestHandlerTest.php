...
final class UpdateAttendanceModeRequestHandlerTest extends TestCase
{
     ...
     * @test
     */
    public function it_throws_if_offline_attendance_mode_has_online_location(): void
    {
        $request = (new Psr7RequestBuilder())
            ->withRouteParameter('eventId', 'c269632a-a887-4f21-8455-1631c31e4df5')
            ->withJsonBodyFromArray([
     ...
     * @test
     */
    public function it_throws_if_mixed_attendance_mode_has_online_location(): void
    {
        $request = (new Psr7RequestBuilder())
            ->withRouteParameter('eventId', 'c269632a-a887-4f21-8455-1631c31e4df5')
            ->withJsonBodyFromArray([
