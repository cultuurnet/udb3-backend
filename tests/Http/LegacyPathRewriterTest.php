...
class LegacyPathRewriterTest extends TestCase
{
    ...
    public function rewritesDataProvider(): array
    {
        return [
            ...
            'place_detail_singular_to_pluralized_and_trailing_slash' => [
            ...
            'event_detail_without_prefixed_slash_singular_to_pluralized_and_trailing_slash' => [
                'original' => 'event/ccb8f44b-d316-41f0-aeec-2b4149be6cd3',
                'rewrite' => 'events/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/',
            ],
            'place_detail_without_prefixed_slash_singular_to_pluralized_and_trailing_slash' => [
                'original' => 'place/ccb8f44b-d316-41f0-aeec-2b4149be6cd3',
                'rewrite' => 'places/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/',
            ],
            ...
            'place_update_name_singular_to_pluralized_and_trailing_slash' => [
            ...
            'event_singular_calsum_to_pluralized_calendar_summary_and_trailing_slash' => [
            ...
            'place_singular_calsum_to_pluralized_calendar_summary_and_trailing_slash' => [
            ...
            'event_calsum_to_calendar_summary_and_trailing_slash' => [
                'original' => '/events/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/calsum',
                'rewrite' => '/events/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/calendar-summary/',
            ],
            'place_calsum_to_calendar_summary_and_trailing_slash' => [
                'original' => '/places/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/calsum',
                'rewrite' => '/places/ccb8f44b-d316-41f0-aeec-2b4149be6cd3/calendar-summary/',
            ],
            'news_articles_with_underscore_to_hyphen_and_trailing_slash' => [
                'original' => '/news_articles',
                'rewrite' => '/news-articles/',
            ],
            'news_articles_detail_with_underscore_to_kebab_case_and_trailing_slash' => [
                'original' => '/news_articles/8a5fcfae-e698-437a-87a5-32cd4ac61076',
                'rewrite' => '/news-articles/8a5fcfae-e698-437a-87a5-32cd4ac61076/',
            ],
            'event_update_booking_availability_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_booking_info_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_contact_point_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_major_info_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_price_info_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_sub_events_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_update_typical_age_range_camel_case_to_kebab_case_and_trailing_slash' => [
            ...
            'event_uitpas_distribution_keys_camel_case_to_kebab_case_and_trailing_slash' => [
