...
{
    /**
     * @var ImportPlaceDocumentDeserializer
     */
    private $deserializer;

    public function setUp()
    {
        $this->deserializer = new ImportPlaceDocumentDeserializer();
    }
    ...
    public function it_should_throw_an_exception_if_id_is_missing()
    {
        $json = json_encode(
            [
                'url' => 'http://io.uitdatabank.be/places/681dc7f1-86a1-43ec-8fa5-09ce28e5a05e',
                'jwt' => 'foo.bar.acme',
    ...
    public function it_should_create_an_import_command()
    {
        ...
        $expected = new ImportPlaceDocument(
            '681dc7f1-86a1-43ec-8fa5-09ce28e5a05e',
            'http://io.uitdatabank.be/places/681dc7f1-86a1-43ec-8fa5-09ce28e5a05e',
            'foo.bar.acme',
