...
final class OrganizerCardSystemsUpdatedDeserializerTest extends TestCase
{
    private OrganizerCardSystemsUpdatedDeserializer $deserializer;

    public function setUp(): void
    {
        $this->deserializer = new OrganizerCardSystemsUpdatedDeserializer();
    }
    ...
    public function it_should_deserialize_a_valid_message(): void
    {
        $json = Json::encode(
            [
                'id' => '48ef34b0-e34a-4a15-9ae2-a5a01f189f90',
                'cardSystems' => [
                    [
                        'id' => 7,
     ...
     * @test
     */
    public function it_should_throw_an_exception_when_the_id_property_is_missing(): void
    {
