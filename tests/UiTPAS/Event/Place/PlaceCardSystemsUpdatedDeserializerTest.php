...
final class PlaceCardSystemsUpdatedDeserializerTest extends TestCase
{
    private PlaceCardSystemsUpdatedDeserializer $deserializer;

    public function setUp(): void
    {
        $this->deserializer = new PlaceCardSystemsUpdatedDeserializer();
    }
